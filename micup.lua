...
local function updateBaseplatePositions()
    ...
    if character and character:FindFirstChild("HumanoidRootPart") then
        local clientBaseplate = workspace:FindFirstChild("ClientBaseplate")
        local lowerClientBaseplate = workspace:FindFirstChild("LowerClientBaseplate")
        if clientBaseplate and lowerClientBaseplate then
            local rootPart = character.HumanoidRootPart
            local baseplateCenter = clientBaseplate.Position
